...
;;; Commentary:
;;; silkworm theme created by  in 2025
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(default-italic ((,class (:italic t))))
	 ...
	 `(org-code ((,class (:foreground ,builtin :background ,bg2 :bold t))))
	 `(org-hide ((,class (:foreground ,fg4))))
   `(org-level-1 ((,class (:bold t :foreground ,builtin :height 1.1))))
   `(org-level-2 ((,class (:bold t :foreground ,keyword))))
   `(org-level-3 ((,class (:bold t :foreground ,str))))
   `(org-level-4 ((,class (:bold t :foreground ,warning2))))
   `(org-level-5 ((,class (:bold nil :foreground ,func))))
   ...
   `(org-scheduled-today ((,class (:foreground ,func :weight bold :height 1.2))))
	 ...
	 `(org-verbatim ((,class (:foreground ,warning))))
   ...
   `(rainbow-delimiters-depth-1-face ((,class :foreground ,keyword :weight bold)))
   `(rainbow-delimiters-depth-2-face ((,class :foreground ,func :weight bold)))
   `(rainbow-delimiters-depth-3-face ((,class :foreground ,builtin :weight bold)))
   `(rainbow-delimiters-depth-4-face ((,class :foreground ,const :weight bold)))
   `(rainbow-delimiters-depth-5-face ((,class :foreground ,var :weight bold)))
   `(rainbow-delimiters-depth-6-face ((,class :foreground ,warning2 :weight bold)))
   `(rainbow-delimiters-depth-7-face ((,class :foreground ,type :weight bold)))
   `(rainbow-delimiters-depth-8-face ((,class :foreground ,fg1 :weight bold)))
   `(rainbow-delimiters-depth-9-face ((,class :foreground ,str :weight bold)))
