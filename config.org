...
#+RESULTS:
: [nil 26975 64280 523831 nil elpaca-process-queues nil nil 933000 nil]
...
#+RESULTS:
| dashboard-insert-startupify-lists | #[nil ((set-face-attribute 'mode-line nil :box nil) (set-face-attribute 'mode-line-inactive nil :box nil)) nil] | elpaca-process-queues | org-persist-load-all | pgtk-use-im-context-handler | tramp-register-archive-autoload-file-name-handler |
